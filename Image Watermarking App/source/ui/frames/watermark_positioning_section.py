...
class WatermarkPositioningSection(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        # PRIVATE VARIABLES
        self.__x_pos_scale = None          # watermark horizontal positioning scale
        self.__y_pos_scale = None          # watermark vertical positioning scale
    ...
    def get_x_pos_value(self):
        """
        Get the value stored in the x pos scale
        :returns: The x pos value
        """

        return self.__x_pos_scale.get()

    def get_y_pos_value(self):
        """
        Get the value stored in the y pos scale
        :returns: The y pos value
        """

        return self.__y_pos_scale.get()

    def set_x_pos_scale_cmd(self, cmd: Callable):
        """
    ...
    def set_y_pos_scale_cmd(self, cmd: Callable):
        """
        Set the command for when the scale is interacted with
        :param cmd: The function to call when the scale is interacted with
        """
